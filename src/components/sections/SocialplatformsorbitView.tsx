...
/**
 * PlatformsMarqueeView
 * ---------------------------------------------------------------------
 * Client half of the Platforms marquee — split off so the parent
 * Socialplatformsorbit.tsx can be a Server Component fetching real Social
 * Link data. Visual design and motion are untouched from the original.
 */

import Image from "next/image";
import LiquidEther from "./Liquidether";

export type Level = "Expert" | "Avancé" | "Intermédiaire";
...
export function PlatformsMarqueeView({ platforms }: { platforms: PlatformItem[] }) {
  ...
  return (
    <section className="pm-section">
      ...
      <div className="pm-header">
        <span className="pm-marker">05 — PLATEFORMES</span>
