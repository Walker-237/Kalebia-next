 ...
 * Formations
 * ---------------------------------------------------------------------
 * §7 pattern: "Premium 'magazine cover' treatment, large type, minimal
 * metadata." No cards — each course is a full-width editorial chapter,
 * alternating left/right per the 5/7-7/5 asymmetry rule, with a huge
 * low-opacity Fraunces numeral behind the title (the GhostType device
 * from §6, applied per-item instead of section-wide).
 *
 * Same gold LiquidEther background family as Platforms, tuned to sit
 * higher-presence here (this section is meant to carry it, per "magazine
 * cover") — but it's the ONLY other canvas on the page. The visibility
 * pausing in LiquidEther means at most one of the two is ever actually
 * rendering, since they're never both in viewport together.
 */
...
const COURSES: Course[] = [
  {
    ...
    title: "Comment maîtriser les réseaux sociaux",
    desc: "Structurer votre présence, créer du contenu engageant et analyser vos performances sur les principales plateformes.",
    href: "https://nkprod.netlify.app/formation.html?slug=maitriser-reseaux-sociaux",
  },
  {
    slug: "reussir-community-management",
    title: "Réussir en Community Management",
    desc: "De la stratégie à l'animation quotidienne : devenez un community manager opérationnel et crédible.",
    href: "https://nkprod.netlify.app/formation.html?slug=reussir-community-management",
  },
];
  ...
  return (
    <section className="fm-section">
      ...
      <div ref={header.ref} className={`fm-header ${header.inView ? "is-in" : ""}`}>
        <span className="fm-marker">06 — FORMATIONS</span>
