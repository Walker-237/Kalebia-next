 ...
 * LiquidEther
 * ---------------------------------------------------------------------
 * Vendored WebGL fluid-sim background (three.js, imperative shader
 * pipeline). This is infrastructure, not application code, so the
 * internals are left under `ts-nocheck` rather than fighting strict
 * mode over a physics engine — but the exported component still has a
 * real, typed props surface (see LiquidEtherProps below), so usage
 * elsewhere in the app gets normal autocomplete/type-checking.
 *
